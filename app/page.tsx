      ...
      <div className="glass-surface glass-specular w-full max-w-6xl rounded-(--glass-radius-lg) p-8">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.5fr_1fr]">
          <div className="rounded-xl border border-border bg-background/80 p-6 shadow-sm shadow-black/5 backdrop-blur-xl">
            <h2 className="text-xl font-semibold">{isAdmin ? "Admin portal overview" : "Lister dashboard overview"}</h2>
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              {isAdmin
                ? "This portal is the admin control center for the listing platform. Use it to review lister activity, manage global settings, and enforce the admin allowlist."
                : "This portal is your lister workspace. Manage your own listings, enquiries, and analytics without access to other listers' data or admin-only functions."}
            </p>
          ...
          <div className="rounded-xl border border-border bg-background/80 p-6 shadow-sm shadow-black/5 backdrop-blur-xl">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
              {isAdmin ? (
                <>
                  <li>• Review pending listings, approvals, and reported activity.</li>
                  <li>• Manage site settings, admin allowlist, and user roles.</li>
                  <li>• Monitor audit logs and platform health.</li>
                </>
              ) : (
                <>
