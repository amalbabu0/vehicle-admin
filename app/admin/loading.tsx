...
// loading.tsx. Without shell-shaped chrome here, the sidebar/header/bottom
// nav disappeared entirely in favor of a content-only skeleton on every hard
// refresh or deep link. Mirrors AdminShell/AdminSidebar/AdminHeader's exact
// static structure (widths, the 9 nav items, h-16 rows) since none of their
// real data (profile, notification counts) exists yet at this point.
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 space-y-4 overflow-y-auto p-4 pb-24 sm:p-6 lg:pb-6">
