...
import { Bell, ChevronDown, LogOut, Plus, ClipboardCheck } from "lucide-react";
          ...
          <DropdownMenuTrigger asChild>
            <Button type="button" variant="outline" size="icon" className="relative" aria-label="Notifications">
              ...
              {pendingApprovalCount > 0 ? (
                <Badge className="absolute -right-1.5 -top-1.5 h-4.5 min-w-4.5 justify-center rounded-full px-1 text-[10px]">
